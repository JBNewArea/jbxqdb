...
//        Object principal = subject.getPrincipal();  //此处为用户名
//        PrincipalCollection principals = subject.getPrincipals(); //暂时不确定是否有用户多信息
//        List<UserFormMap> userlist = userMapper.findByAttribute("accountName", principal.toString(), UserFormMap.class);
//        UserFormMap userFormMap = userlist.get(0);
		System.out.println(resFormMap);
	...
	public String logout() {
		...
		return "redirect:http://120.26.101.165:8088/cas/logout?service=http://127.0.0.1:8080/jbxqdb";
	}
