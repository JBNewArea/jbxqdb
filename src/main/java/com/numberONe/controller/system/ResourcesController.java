...
public class ResourcesController extends BaseController {
	...
	public ResFormMap findByPage(Model model,HttpServletRequest request) {
		...
		List<ResFormMap> mps = resourcesMapper.selectByName(resFormMap);
	...
	@SystemLog(module="基础管理",methods="菜单管理-新增菜单")//凡需要处理业务逻辑的.都需要记录操作日志
	...
	@Transactional(readOnly=false)//需要事务操作必须加入此注解
	@SystemLog(module="基础管理",methods="菜单管理-修改菜单")//凡需要处理业务逻辑的.都需要记录操作日志
	...
	@SystemLog(module="基础管理",methods="菜单管理-删除菜单")//凡需要处理业务逻辑的.都需要记录操作日志
	...
	@Transactional(readOnly=false)//需要事务操作必须加入此注解
	@SystemLog(module="基础管理",methods="用户管理/组管理-修改权限")//凡需要处理业务逻辑的.都需要记录操作日志
