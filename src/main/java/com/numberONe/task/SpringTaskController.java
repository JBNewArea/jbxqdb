...
//				EmailUtils.sendMail(prop.getProperty("fromEmail"), email, prop.getProperty("emailName"), prop.getProperty("emailPassword"), title, centent);
				EmailUtils.sendMail2(prop.getProperty("emailName"), prop.getProperty("emailPassword"), prop.getProperty("host"), prop.getProperty("fromEmail"), email, title, centent);
				// 保存预警信息
