...
public final class DateUtils {
	...
	/** ���ڸ�ʽ: yyyyMM */
	public static final String DATE_FORMAT_MONTH_EN = "yyyyMM";
	...
	/** ���ڸ�ʽ:yyyyMMdd String pattern = "yyyy-MM-dd'T'HH:mm:ss:SSSZZ";*/
	public static final String DATE_FORMAT_ISO_UTC = "yyyy-MM-dd'T'HH:mm:ss.SSSZZ";
	...
	public static String date2StringDay2(Date date) {
		return date2String(date, DATE_FORMAT_DAY_EN);
	}
	...
	public static String date2StringMonth2(Date date) {
		return date2String(date, DATE_FORMAT_MONTH_EN);
	}
