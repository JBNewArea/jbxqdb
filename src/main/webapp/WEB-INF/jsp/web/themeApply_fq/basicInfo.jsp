...
<script type="text/javascript" src="${ctx}/js/web/themeApply_fq/basicInfo.js"></script>
...
<div class="l_err" style="width: 100%; margin-top: 2px;"></div>
	...
	<section class="panel panel-default">
			...
			<input type="hidden" class="form-control" name="matterThemeId" value="${matterTheme.id }">
			<input type="hidden" class="form-control" name="id" value="${matterTheme.id }">
			<div class="panel-body">
			
			<!-- 申请单位信息 -->
			<div class="title">
						基本信息(带 <span class="xinhao">*</span> 为必填项)
					</div>
			...
			<tbody style="border-color: inherit;">
				<tr>
					...
					<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
						<input type="text" class="form-control"  name="matterThemeName" style="background-color:#eff0f4;border-radius:0px;width:100%;"
						 validate="{required:true}" disabled>
					</td>
					<td class="top_left_td">
						项目名称<span class="needed">*</span>
					</td>
					<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
				...
				<tr>
					...
					<td class="top_left_td">
						申请单位证件类型<span class="needed">*</span>
					</td>
					<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
						<select name="applicantDocumentType" style="border-radius:0px;" class="status-valid creatable editable pointer form-control status_selector" validate="{required:true}">
				...
				<tr>
					...
					<td class="top_left_td">
						联系电话<span class="needed">*</span>
					</td>
					<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
						<input type="text" class="form-control isMobile"  name="applicationPhone" 
						 validate="{required:true}" >
					</td>
				</tr>
				<tr>
					...
					<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
						<input type="text" class="form-control isyoubian"  name="applicationPostCode" 
						>
					</td>
					<td class="top_left_td">
						通讯地址
				...
				<tr>
					...
					<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
						<input type="text" class="form-control"  name="yongdi" 
						  >
					</td>
					<td class="top_left_td">
						总建筑面积（万平方米）
					...
					<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
						<input type="text" class="form-control" name="zongjianzhu" 
							 >
					</td>
				</tr>
				...
				<tr>
					...
					<td class="right_td" colspan="3">
						<input type="text" name="yuanqu" titile="" style="width:40%;float:left;border-radius:0px;" class="form-control">
					</td>
				</tr>
				
				<tr>
					<td class="left_td">
						总投资额<span class="needed">*</span>
					</td>
					<td class="right_td" colspan="3" style="padding-left:10px;padding-right:10px;">
						<input type="text" class="form-control required num" name="invest" 
						 validate="{required:true,isNumber:true}" style="width:80%;float:left;"  >
				...
				<tr>
					...
					<td class="right_td" colspan="3">	
						<textarea rows="5" cols="10" name="mainLandContent" style="resize:none;background-color:#eff0f4;border-radius:0px;width:100%;" class="form-control"  validate="{required:true}"    >${matterTheme.mainLandContent}</textarea>
					</td>
				</tr>
				...
				<!-- <tr>
					...
					<td class="right_td" colspan="3">
						...
						<input type="text" name="matterName" style="width:40%;float:left;border-radius:0px;" class="form-control" readonly>
			...
			<table class="xiangmuweituo_table" border="1" style="width:100%;border:1px;border-spacing: 2px;border-collapse: collapse;border-color:#DBDCDD;">
				<tbody style="border-color: inherit;">
					<tr>
						...
						<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
							<input type="text" class="form-control"  name="xzq" 
							 >
						</td>
						<td class="top_left_td">
							代办中心名称
						...
						<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
							<input type="text" class="form-control"  name="dbzxName" 
							  >
						</td>
					</tr>
					<tr>
						...
						<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
							<input type="text" class="form-control date"  name="qyTime"
							 >
						</td>
						<td class="top_left_td">
							协议号
						...
						<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
							<input type="text" class="form-control"  name="xieyihao" 
							  >
						</td>
					</tr>
					<tr>
						...
						<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
							<input type="text" class="form-control"  name="bumen" 
							 >
						</td>
						<td class="top_left_td">
							主要代办人员
						...
						<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
							<input type="text" class="form-control"  name="personOne" 
							  >
						</td>
					</tr>
					<tr>
						...
						<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
							<input type="text" class="form-control"  name="personTwo" 
							 >
						</td>
						<td class="top_left_td">
							代办形式
						...
						<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
							<input type="text" class="form-control"  name="daibanStyle" 
							  >
						</td>
					</tr>
					<tr>
						...
						<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
							<input type="text" class="form-control"  name="weituoStart" 
							 >
						</td>
						<td class="top_left_td">
							委托代办结束环节
						...
						<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
							<input type="text" class="form-control"  name="weituoEnd" 
							  >
						</td>
					</tr>
			...
			<table class="weituodanwei_table" border="1" style="width:100%;border:1px;border-spacing: 2px;border-collapse: collapse;border-color:#DBDCDD;">
				<tbody style="border-color: inherit;">
					...
					<tr>
						...
						<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
							<input type="text" class="form-control"  name="danweiStyle" 
							 >
						</td>
						<td class="top_left_td">
							项目经办人
						...
						<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
							<input type="text" class="form-control"  name="projectPerson" 
							  >
						</td>
					</tr>
					<tr>
						...
						<td class="top_right_td" style="padding-left:10px;padding-right:10px;">
							<input type="text" class="form-control"  name="personPosition" 
							 >
						</td>
						<td class="top_left_td">
							经办人电话
					...
					<td class="right_td" colspan="3" style="padding-left:10px;padding-right:10px;">
						<input type="text" class="form-control  " name="youxiang" 
						  style="width:100%;float:left;"  >
					</td>
				</tr>
				</tbody>
		...
		<button  class="btn btn-primary btn-send btn-s-xs">开始代办</button>
		</footer> </section>
	</form>
